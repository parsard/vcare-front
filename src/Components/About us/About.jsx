...
const About = () => {
  return (
    <div
      ...
      style={{ transform: "translateX(-30px)", marginTop: "10px" }}
    >
      <h1
        className="text-xl font-semibold text-[#00818d] mb-4 self-end "
        style={{ marginTop: "-30px", marginRight: "60px" }}
      >
        چرا وی کر؟
      </h1>

      {/* SVG as the main background */}
      <div className="relative w-[1150px] h-[350px]">
        ...
        <div
          ...
          style={{ lineHeight: "53px", color: "#00818d" }}
        >
